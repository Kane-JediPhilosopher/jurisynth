...
- q001; required dependencies none; starts +0.00 min, finishes +10.76 min. Retrieval 4.70 min; attributable interpreter interval 0.00 min, possible upper bound 4.70 min; uninstrumented retrieval remainder therefore at least 0.00 min (temporal bounds, not CPU attribution). Answer generation 6.06 min; at least 2 correlated answer attempts across 2 calls, 1 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q002; required dependencies none; starts +0.00 min, finishes +11.15 min. Retrieval 6.36 min; attributable interpreter interval 0.00 min, possible upper bound 4.94 min; uninstrumented retrieval remainder therefore at least 1.41 min (temporal bounds, not CPU attribution). Answer generation 4.80 min; at least 2 correlated answer attempts across 1 calls, 0 correlated length completions; 1 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q003; required dependencies ['q001', 'q002']; starts +11.15 min, finishes +28.34 min. Retrieval 12.63 min; attributable interpreter interval 0.00 min, possible upper bound 6.56 min; uninstrumented retrieval remainder therefore at least 6.07 min (temporal bounds, not CPU attribution). Answer generation 4.56 min; at least 1 correlated answer attempts across 1 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q004; required dependencies ['q002']; starts +11.15 min, finishes +29.70 min. Retrieval 16.33 min; attributable interpreter interval 0.00 min, possible upper bound 6.56 min; uninstrumented retrieval remainder therefore at least 9.78 min (temporal bounds, not CPU attribution). Answer generation 2.21 min; at least 1 correlated answer attempts across 1 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q005; required dependencies ['q003', 'q004']; starts +29.70 min, finishes +63.57 min. Retrieval 23.80 min; attributable interpreter interval 0.00 min, possible upper bound 2.80 min; uninstrumented retrieval remainder therefore at least 21.00 min (temporal bounds, not CPU attribution). Answer generation 10.07 min; at least 4 correlated answer attempts across 2 calls, 1 correlated length completions; 2 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q006; required dependencies ['q003']; starts +29.70 min, finishes +60.51 min. Retrieval 14.91 min; attributable interpreter interval 0.00 min, possible upper bound 2.80 min; uninstrumented retrieval remainder therefore at least 12.11 min (temporal bounds, not CPU attribution). Answer generation 15.90 min; at least 7 correlated answer attempts across 2 calls, 1 correlated length completions; 5 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 1.36 min.
...
Uncorrelated leaf call IDs: ['a74160d5d54b4b5697eb8356c680c9cb', '2e2f48c59bc44db084a10f566529873e', '01f93294935b4143bf653375bbd10e2b', 'fbfe6cef12294cfc8659fc9e092d8790', 'f0a7c13f4a474c5a9ff4304e40279f67', '2b1a75ad12704c9d95ef4327a0d9f219']

## organized: per-leaf breakdown

Leaf-execution wall time: 76.25 minutes.

- q001; required dependencies none; starts +0.00 min, finishes +20.23 min. Retrieval 14.24 min; attributable interpreter interval 0.00 min, possible upper bound 1.67 min; uninstrumented retrieval remainder therefore at least 12.58 min (temporal bounds, not CPU attribution). Answer generation 5.98 min; at least 3 correlated answer attempts across 2 calls, 1 correlated length completions; 1 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q002; required dependencies none; starts +0.00 min, finishes +19.63 min. Retrieval 17.32 min; attributable interpreter interval 0.00 min, possible upper bound 1.67 min; uninstrumented retrieval remainder therefore at least 15.65 min (temporal bounds, not CPU attribution). Answer generation 2.31 min; at least 1 correlated answer attempts across 1 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q003; required dependencies ['q001', 'q002']; starts +20.23 min, finishes +55.34 min. Retrieval 31.61 min; attributable interpreter interval 0.00 min, possible upper bound 2.61 min; uninstrumented retrieval remainder therefore at least 29.01 min (temporal bounds, not CPU attribution). Answer generation 3.50 min; at least 1 correlated answer attempts across 1 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q004; required dependencies ['q001']; starts +20.23 min, finishes +49.18 min. Retrieval 24.98 min; attributable interpreter interval 0.00 min, possible upper bound 2.61 min; uninstrumented retrieval remainder therefore at least 22.37 min (temporal bounds, not CPU attribution). Answer generation 3.97 min; at least 1 correlated answer attempts across 1 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q005; required dependencies ['q002']; starts +20.23 min, finishes +55.54 min. Retrieval 31.66 min; attributable interpreter interval 0.00 min, possible upper bound 2.61 min; uninstrumented retrieval remainder therefore at least 29.05 min (temporal bounds, not CPU attribution). Answer generation 3.65 min; at least 0 correlated answer attempts across 0 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.59 min.

- q006; required dependencies ['q005']; starts +55.54 min, finishes +72.00 min. Retrieval 15.01 min; attributable interpreter interval 0.00 min, possible upper bound 5.92 min; uninstrumented retrieval remainder therefore at least 9.09 min (temporal bounds, not CPU attribution). Answer generation 1.46 min; at least 1 correlated answer attempts across 1 calls, 0 correlated length completions; 0 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.00 min.

- q007; required dependencies ['q001', 'q002', 'q003']; starts +55.54 min, finishes +76.25 min. Retrieval 11.27 min; attributable interpreter interval 0.00 min, possible upper bound 5.92 min; uninstrumented retrieval remainder therefore at least 5.35 min (temporal bounds, not CPU attribution). Answer generation 9.44 min; at least 4 correlated answer attempts across 2 calls, 1 correlated length completions; 2 correlated503 retries (ambiguous calls remain unassigned; zero does not mean no call). Start delay after required prerequisites ready 0.19 min.
...
Uncorrelated leaf call IDs: ['103a7c9439d74011b0f8c4dfa536425d', 'c577362f9f14421a821597c2bb9d862c', '6614cfc5b3ae47a1955e31e13e2aef87', '2ec915f476d44b85826d0f4dc9ca4dfb', 'a9a2da9a6dfa4e0ba6c3236a6b1b1567', 'ee55cf89cefe4ad0bcaada918a2d9eb9', '5c2fd1bcc6694dbe851c16e53a236ac6', '85b5d5e680ae4b638e6ea6f5e07ed933']
